    ...
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                default: 'json',
                description:
                    'Формат ответа. Вам нужно включить форматы поиска в settings.yml. См. <a target="_blank" href="https://docs.OSMIai.com/integrations/langchain/tools/searxng">Руководство по настройке SearXNG</a> для получения дополнительной информации.',
                additionalParams: true
            },
            {
                label: 'Категории',
