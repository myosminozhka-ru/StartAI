...
import OSMIGoogleAICacheManager from './OSMIGoogleAICacheManager'
...
class GoogleGenerativeAIContextCache implements INode {
    ...
    constructor() {
        ...
        this.category = 'Cache'
        this.baseClasses = [this.type, ...getBaseClasses(OSMIGoogleAICacheManager)]
        this.inputs = [
            {
    ...
    async init(nodeData: INodeData, _: string, options: ICommonObject): Promise<any> {
        ...
        const manager = new OSMIGoogleAICacheManager(apiKey)
