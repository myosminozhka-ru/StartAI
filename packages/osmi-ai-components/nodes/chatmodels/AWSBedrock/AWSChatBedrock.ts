...
import { BedrockChat } from './OSMIAWSChatBedrock'
    ...
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                type: 'boolean',
                description:
                    'Разрешить ввод изображений. Подробнее в <a href="https://docs.OSMIai.com/using-OSMI/uploads#image" target="_blank">документации</a>.',
                default: false,
                optional: true
            },
            {
