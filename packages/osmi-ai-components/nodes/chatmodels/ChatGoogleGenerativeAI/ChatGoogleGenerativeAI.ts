...
import { ChatGoogleGenerativeAI } from './OSMIChatGoogleGenerativeAI'
import type OSMIGoogleAICacheManager from '../../cache/GoogleGenerativeAIContextCache/OSMIGoogleAICacheManager'
...
class GoogleGenerativeAI_ChatModels implements INode {
    ...
    async init(nodeData: INodeData, _: string, options: ICommonObject): Promise<any> {
        ...
        const contextCache = nodeData.inputs?.contextCache as OSMIGoogleAICacheManager
