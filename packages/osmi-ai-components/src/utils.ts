...
export const OSMI_CHATID = 'OSMI_chatId'
...
const jsonEscapeCharacters = [
    { escape: '"', value: 'OSMI_DOUBLE_QUOTE' },
    { escape: '\n', value: 'OSMI_NEWLINE' },
    { escape: '\b', value: 'OSMI_BACKSPACE' },
    { escape: '\f', value: 'OSMI_FORM_FEED' },
    { escape: '\r', value: 'OSMI_CARRIAGE_RETURN' },
    { escape: '\t', value: 'OSMI_TAB' },
    { escape: '\\', value: 'OSMI_BACKSLASH' }
]
