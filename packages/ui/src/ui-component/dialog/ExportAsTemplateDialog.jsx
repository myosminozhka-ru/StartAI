    ...
    const component = show ? (
        ...
        >
            <DialogTitle sx={{ fontSize: '1rem' }} id='alert-dialog-title'>
                {dialogProps.title || 'Экспорт как шаблон'}
            </DialogTitle>
            <DialogContent>
                <Box sx={{ pt: 2, pb: 2 }}>
                ...
                <Box sx={{ pt: 2, pb: 2 }}>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                        <Typography sx={{ mb: 1 }}>Описание</Typography>
                        <OutlinedInput
                            id={'description'}
                            type={'string'}
                            fullWidth
                ...
                <Box sx={{ pt: 2, pb: 2 }}>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                        <Typography sx={{ mb: 1 }}>Значок</Typography>
                        <OutlinedInput
                            id={'badge'}
                            type={'string'}
                            fullWidth
                ...
                <Box sx={{ pt: 2, pb: 2 }}>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                        <Typography sx={{ mb: 1 }}>Случаи использования</Typography>
                        {usecases.length > 0 && (
                        ...
                        <Typography variant='body2' sx={{ fontStyle: 'italic', mt: 1 }} color='text.secondary'>
                            Введите вариант использования и нажмите enter, чтобы добавить его в список. Вы можете добавить столько
            ...
            <DialogActions>
                <Button onClick={onCancel}>{dialogProps.cancelButtonName || 'Отменить'}</Button>
                <StyledButton disabled={dialogProps.disabled} variant='contained' onClick={onConfirm}>
                    {dialogProps.confirmButtonName || 'Сохранить шаблон'}
                </StyledButton>
            </DialogActions>
        </Dialog>
    ) : null
