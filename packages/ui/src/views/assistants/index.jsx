...
const cards = [
    {
        ...
        description: 'Создайте пользовательского ассистента, используя выбранные вами языковые модели',
        icon: <IconRobotFace />,
        iconText: 'Пользовательский',
        gradient: 'linear-gradient(135deg, #fff8e14e 0%, #ffcc802f 100%)'
    },
    {
        title: 'OpenAI ассистент',
        description: 'Создайте ассистента, используя OpenAI Assistant API',
        icon: <IconBrandOpenai />,
        iconText: 'OpenAI',
        gradient: 'linear-gradient(135deg, #c9ffd85f 0%, #a0f0b567 100%)'
    },
    {
        title: 'Azure ассистент (Скоро)',
        description: 'Создайте ассистента, используя Azure Assistant API',
        icon: <IconBrandAzure />,
        iconText: 'Azure',
        ...
        <>
            <MainCard>
                <Stack flexDirection='column' sx={{ gap: 3 }}>
                    <ViewHeader
                        title='Ассистенты'
                        description='Чат-ассистенты с инструкциями, инструментами и файлами для ответов на запросы пользователей'
                    />
                    <FeatureCards />
                </Stack>
            </MainCard>
