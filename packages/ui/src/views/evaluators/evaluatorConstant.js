...
export const evaluators = [
    ...
    {
        type: 'numeric',
        label: 'Задержка Агента',
        name: 'chain',
        description: 'Фактическое время, затраченное на выполнение агента (миллисекунды).'
    },
    {
        type: 'numeric',
...
export const evaluatorTypes = [
    {
        ...
        name: 'text',
        description: 'Набор оценщиков для оценки результата агента.'
    },
    {
        label: 'Оценка Результата (JSON)',
        name: 'json',
        description: 'Набор оценщиков для оценки JSON-ответа агента.'
    },
    {
        label: 'Оценка Метрик (Числовые)',
        name: 'numeric',
        description: 'Набор оценщиков, которые оценивают метрики (задержка, токены, стоимость, длина ответа) агента.'
    },
    {
