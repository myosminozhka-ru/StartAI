...
const SignInPage = () => {
    ...
    // Чекбокс показывается для всех пользователей
    // Если в будущем понадобится показывать только для определенных ролей,
    // можно добавить логику определения роли здесь
