        ...
        >
            ...
            <DialogContent>
                <>
                    ...
                    >
                        <StatsCard title='Добавлено' stat={dialogProps.numAdded ?? 0} />
                        <StatsCard title='Обновлено' stat={dialogProps.numUpdated ?? 0} />
                        <StatsCard title='Пропущено' stat={dialogProps.numSkipped ?? 0} />
                        <StatsCard title='Удалено' stat={dialogProps.numDeleted ?? 0} />
                    </div>
                    {dialogProps.addedDocs && dialogProps.addedDocs.length > 0 && (
                        <Typography sx={{ mt: 2, mb: 2, fontWeight: 500 }}>{dialogProps.numAdded} Добавленных документов</Typography>
                    )}
