        ...
        <MainCard>
            {error ? (
                ...
                <Stack flexDirection='column' sx={{ gap: 3 }}>
                    <ViewHeader title='Выполнения агентов' description='Мониторинг и управление выполнением потоков агентов' />
                        ...
                        <Grid container spacing={2} alignItems='center'>
                            <Grid item xs={12} md={2}>
                                <FormControl fullWidth size='small'>
                                    <InputLabel id='state-select-label'>Состояние</InputLabel>
                                    <Select
                                    ...
                                    >
                                        ...
                                        <MenuItem value='TERMINATED'>Прервано</MenuItem>
                                        <MenuItem value='TIMEOUT'>Таймаут</MenuItem>
                                        <MenuItem value='STOPPED'>Остановлено</MenuItem>
                                    </Select>
                                </FormControl>
                            </Grid>
                            <Grid item xs={12} md={2}>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mt: 2 }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                            <Typography variant='body2'>Элементов на странице:</Typography>
                            <FormControl
                                variant='outlined'
                                size='small'
                                sx={{
                    ...
                    >
                        ...
                        <DialogContent>
                            <DialogContentText id='alert-dialog-description'>
                                Вы уверены, что хотите удалить {selectedExecutionIds.length} выполнение
                                {selectedExecutionIds.length !== 1 ? 'й' : 'е'}? Это действие нельзя отменить.
                            </DialogContentText>
                        </DialogContent>
                        <DialogActions>
                        ...
                        <Stack sx={{ alignItems: 'center', justifyContent: 'center' }} flexDirection='column'>
                            <Box sx={{ p: 2, height: 'auto' }}>
                                <img
                                    ...
                                    src={execution_empty}
                                    alt='Нет выполненных операций'
                                />
                            </Box>
                            <div>Пока нет выполненных операций</div>
                        </Stack>
                    )}
                </Stack>
            )}
