...
export class OrganizationUserController {
    ...
    public async delete(req: Request, res: Response, next: NextFunction) {
        ...
        try {
            ...
            if (!query.userId) {
                throw new InternalStartAIError(StatusCodes.BAD_REQUEST, 'User ID is required')
            }
            ...
            if (currentPlatform === Platform.ENTERPRISE) {
                ...
                if (!deleteUser) throw new InternalStartAIError(StatusCodes.INTERNAL_SERVER_ERROR, GeneralErrorMessage.UNHANDLED_EDGE_CASE)
