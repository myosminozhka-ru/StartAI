import { STARTAI_METRIC_COUNTERS, IMetricsProvider } from '../Interface.Metrics'
...
export class Prometheus implements IMetricsProvider {
    ...
    async initializeCounters(): Promise<void> {
        ...
        const enumEntries = Object.entries(STARTAI_METRIC_COUNTERS)
    ...
    public incrementCounter(counter: STARTAI_METRIC_COUNTERS, payload: any) {
